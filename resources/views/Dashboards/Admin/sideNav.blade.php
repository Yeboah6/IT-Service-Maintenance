...
<div id="mySidenav" class="sidenav">
  ...
  <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex" style="margin: 25px;margin-top:50px">
    <span><i class="fa fa-home" aria-hidden="true"></i></span>
      <x-nav-link :href="route('dashboard')" class="font" :active="request()->routeIs('dashboard')" style="font-size:0.9rem;color:aliceblue;margin-left:10px;">
        {{ __('Dashboard') }}
      </x-nav-link>
  </div>
  <button class="dropdown-btn" style="margin-left: -5px;"><span><i class="fa fa-plus-square-o" aria-hidden="true" style="margin: 15px;font-size: 0.9rem;"></i></span>Incidents</button>
